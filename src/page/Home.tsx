		...
		<div className="w-screen h-screen relative snap-start bg-gradient-to-t from-blue-200 to-blue-500">
			<div className="w-fit absolute left-1/2 sm:left-20 -translate-x-1/2 sm:translate-x-0 top-1/2 -translate-y-1/2 transition-all">
				...
				<div className="mt-5 flex gap-10 text-xl select-none animation-show-delay-3">
					<a className='btn-scale btn-white px-4 py-1 rounded-full shadow-lg underline-animation hover:before:w-[calc(100%-30px)]'>联系我们</a>
					<a className='btn-scale btn-white px-4 py-1 rounded-full shadow-lg underline-animation hover:before:w-[calc(100%-30px)]'>加入我们</a>
					<a className='btn-scale btn-white px-4 py-1 rounded-full shadow-lg underline-animation hover:before:w-[calc(100%-30px)]'>Github主页</a>
				</div>
			</div>
