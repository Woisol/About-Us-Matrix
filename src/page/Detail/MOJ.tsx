	...
	return (
		<div id='MOJ' className="w-screen h-screen relative snap-end pt-20 overflow-hidden">
			<div className="h-full">
				...
				<div className='w-full h-72 sm:w-96 p-10 sm:p-0 sm:pr-10 mt-0 absolute bottom-0 sm:top-1/2 sm:-translate-y-1/2 sm:right-0 flex sm:gap-5 flex-col shrink-0 z-10'>
