	...
	return (
		...
		<div id='exam' className="w-screen h-screen relative snap-end pt-20 overflow-hidde">
			<div className="h-full">
				<div className='w-full h-56 sm:w-64 p-10 sm:p-0 sm:pl-10 mt-0 absolute bottom-20 sm:top-1/2 sm:-translate-y-1/2 sm:left-[calc(1/2*(100vw-700px))] sm:-translate-x-1/2 flex sm:gap-5 flex-col shrink-0 z-10 animation-show-early'>
