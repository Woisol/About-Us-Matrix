	...
	return (
		<div id='course' className="w-screen h-screen relative snap-end pt-20 overflow-hidde">
			<div className="h-full">
				...
				<div className='w-full h-96 sm:w-96 p-10 sm:p-0 sm:pr-10 mt-0 absolute bottom-20 sm:right-[calc(1/2*(100vw-700px))] sm:translate-x-1/2 sm:top-1/2 sm:-translate-y-1/2 flex sm:gap-5 flex-col shrink-0 z-10 animation-show-early'>
