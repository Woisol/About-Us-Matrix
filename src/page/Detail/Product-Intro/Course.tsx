import illuCourse from '../../../assets/Product-Intro/illucourse.jpg'
	...
	return (
		<div id='course' className="w-screen h-screen relative snap-end pt-20 overflow-hidde">
			<div className="h-full">
				<div className="overflow-hidde absolute top-1/4 sm:top-1/2 -translate-y-1/4 sm:-translate-y-1/2 animation-show">
					{/* //!！！！！！！！！！md下次注意父元素有overflow-hidden也会无效！！！！！ */}
					{/* //!同时似乎也不能应用在img上 */}
					{/* //!md必须加个div才能用flex-1 */}
					<img className='w-[500px] max-h-full object-fill' src={illuCourse} alt="Course System" />
				</div>
				<div className='w-full h-96 sm:w-96 p-10 sm:p-0 sm:pr-10 mt-0 absolute bottom-0 sm:right-[calc(1/2*(100vw-500px))] sm:translate-x-1/2 sm:top-1/2 sm:-translate-y-1/2 flex sm:gap-5 flex-col shrink-0 z-10 animation-show'>
